...
param(
    [string]$PluginName = "shurloc-environment"
)
...
#
if (-not (Test-Path "$PluginRoot\shurloc-environment.php")) {
    throw "Plugin bootstrap file 'shurloc-environment.php' was not copied."
}
